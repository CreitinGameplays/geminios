...
rm -rf build
meson setup build --prefix=/usr --libdir=lib/x86_64-linux-gnu -Dglx=enabled -Degl=true -Dgles1=true -Dgles2=true -Dtls=true -Dheaders=true -Dentrypoint-patching=enabled -Dwerror=false
