...
./configure --prefix=/usr --libdir=/usr/lib/x86_64-linux-gnu --with-rootlibexecdir=/usr/lib/udev --sysconfdir=/etc --disable-static --enable-selinux --disable-introspection --disable-blkid --disable-kmod --host=x86_64-linux-gnu
make -j$JOBS
