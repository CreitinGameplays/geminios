...
./configure --prefix=/usr --libdir=/usr/lib/x86_64-linux-gnu --sysconfdir=/etc --disable-static --disable-selinux --disable-introspection --disable-blkid --disable-kmod --host=x86_64-linux-gnu
make -j$JOBS
