...
rm -rf build
meson setup build --prefix=/usr --libdir=lib/x86_64-linux-gnu -Ddefault_library=shared -Denable-x11=true -Denable-wayland=true -Denable-docs=false -Dwerror=false
ninja -C build
