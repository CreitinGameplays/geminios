...
GeminiOS is a minimal, open-source, educational, Debian-derived Linux operating system that does not use `apt`/`dpkg` or `systemd` (initially made by Google Gemini 3, continued by Codex). It also does not rely on build systems like Buildroot.
